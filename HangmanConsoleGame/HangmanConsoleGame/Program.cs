...
namespace HangmanConsoleGame
{
    internal class Program
    {
        ...
        {
            guessLeft = ConvertToIndex(guessLeft);
            string[] hangmanStages = {
            // Default - 7 guesses left
            "--- \n" +
            "| |  \n" +
            "|   \n" +
            "|    \n" +
            ...
            Console.WriteLine(hangmanStages[guessLeft]);
        }
        ...
        static bool VerifyUserInput()
        {
            ...
            {
                Console.WriteLine("Must be a single letter!");
                return false;
            }
            else
            {
                try
                {
                    char letterGuess = userGuess[0];
                    if (char.IsDigit(letterGuess))
                    {
                        Console.WriteLine("Cannot be a number!");
                    }
                    else if (char.IsWhiteSpace(letterGuess))
                    {
                        Console.WriteLine("Cannot be a whitespace!");
                    }
                    else if (char.IsSymbol(letterGuess))
                    {
                        Console.WriteLine("Cannot be a symbol!");
                    }
                    else
                    {
                        return true;
                ...
                {
                    Console.WriteLine("Cannot be an empty space!");
        ...
        static int ConvertToIndex(int guessLeft)
        {
            switch (guessLeft)
            {
                case 1:
